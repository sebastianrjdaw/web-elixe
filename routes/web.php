...
use App\Http\Controllers\Admin\ScreenOnboardingController as AdminScreenOnboardingController;
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/screen-onboarding', [AdminScreenOnboardingController::class, 'index'])->name('screen-onboarding.index');
    Route::get('/screen-onboarding/create', [AdminScreenOnboardingController::class, 'create'])->name('screen-onboarding.create');
    Route::post('/screen-onboarding', [AdminScreenOnboardingController::class, 'store'])->name('screen-onboarding.store');
    Route::get('/screen-onboarding/{screenOnboarding}/edit', [AdminScreenOnboardingController::class, 'edit'])->name('screen-onboarding.edit');
    Route::patch('/screen-onboarding/{screenOnboarding}', [AdminScreenOnboardingController::class, 'update'])->name('screen-onboarding.update');
    Route::post('/screen-onboarding/{screenOnboarding}/submit', [AdminScreenOnboardingController::class, 'submit'])->name('screen-onboarding.submit');
    Route::post('/screen-onboarding/{screenOnboarding}/approve', [AdminScreenOnboardingController::class, 'approve'])->name('screen-onboarding.approve');
    Route::post('/screen-onboarding/{screenOnboarding}/discard', [AdminScreenOnboardingController::class, 'discard'])->name('screen-onboarding.discard');
