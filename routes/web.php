...
Route::post('/locales/solicitud', [LeadController::class, 'storeVenue'])->middleware('throttle:6,1')->name('venues.request');
Route::get('/anunciantes', [PageController::class, 'advertisers'])->name('advertisers');
Route::post('/anunciantes/solicitud', [LeadController::class, 'storeAdvertiser'])->middleware('throttle:6,1')->name('advertisers.request');
